...
<html lang="en">
    ...
    <div class="message" id="mess">
            <p>Напишите нашему <a href="https://t.me/YUKKA_MINECRAFT_BOT" target="_blank">Телеграм боту</a></p>
        </div>
	...
	<g id="Capa_1_216_">
        ...
        <div class="main">
                ...
                <div class="regFields">
                    ...
                    <div class="fields">
                        <form id="form" action="Check/index" method="POST">
                                <input name="nickname" id="nickname" type="text" maxlength="16" placeholder="Логин">
                                <input name="telegram" id="telegram" type="text" placeholder="Ваш Telegram ID">
                                <input name="password" id="password" type="password" placeholder="Пароль"> 
                                <input name="rePassword" id="rePassword" type="password" placeholder="Подтверждение пароля">
        ...
        <div class="tip">
            <p id="ID" onclick="ID()">Как узнать свой Telegram ID</p>
        </div>
